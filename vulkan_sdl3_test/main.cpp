...
private:
   ...
   void createDepthResources() {
      ...
      //createImage(swapChainExtent.width, swapChainExtent.height, mipLevels, VK_SAMPLE_COUNT_1_BIT, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImage, depthImageMemory);
   ...
   void createTextureImage() {
      ...
      //stbi_uc* pixels = stbi_load("textures/texture.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha); // square and image
      ...
      copyBufferToImage(stagingBuffer, textureImage, static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight)); //transitioned to VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL while generating mipmaps
   ...
   std::vector<const char*> getRequiredExtensions() {
      ...
      auto instance_extensions = SDL_Vulkan_GetInstanceExtensions(&count_instance_extensions);
...
private:
   ...
   // we'll load vertices from model file
